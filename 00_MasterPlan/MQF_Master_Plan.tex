...
q=\frac{1+r-d}{u-d}.
\]
Se $V_t$ indica il valore del derivato al tempo $t$, la valutazione
risk-neutral a un periodo \`{e}
\[
V_0=\frac{1}{1+r}\left(qV_1^u+(1-q)V_1^d\right).
\]
...
la sensibilit\`{a} rispetto a $u$, $d$, $r$ e allo strike.
\newline
