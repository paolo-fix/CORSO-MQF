...
operativi concetti probabilistici, finanziari e di ottimizzazione gi\`{a}
discussi nel manuale e nelle slide teoriche.

Ciascuna lezione applicativa ha una durata complessiva di 2 ore e 15 minuti,
di cui 15 minuti destinati alla pausa. Il tempo effettivo di lavoro \`{e}
quindi pari a circa 120 minuti. Le lezioni si svolgono in laboratorio
informatico, con postazioni individuali Windows per gli studenti e schermi di
aula per la proiezione di slide, codice, risultati numerici, grafici e, quando
opportuno, schermate provenienti dalle postazioni degli studenti.

La struttura didattica ricorrente delle lezioni applicative \`{e} articolata
come segue.

\begin{enumerate}
\item \textbf{Introduzione del caso applicativo.} Presentare un problema
finanziario o probabilistico concreto, formulato in modo coerente con i
contenuti teorici del corso.

\item \textbf{Richiamo matematico-operativo.} Richiamare variabili, parametri,
formule principali, vincoli, quantit\`{a} da stimare o ottimizzare.

\item \textbf{Introduzione mirata degli strumenti Python.} Introdurre soltanto
gli elementi di programmazione necessari al caso trattato.

\item \textbf{Sviluppo guidato del codice.} Mostrare il passaggio dalla
formulazione matematica alla struttura computazionale.

\item \textbf{Output, grafici e interpretazione.} Commentare i risultati
numerici e grafici in termini finanziari.

\item \textbf{Esercizi di modifica.} Proporre modifiche dei parametri, delle
ipotesi o del modello per consolidare l'apprendimento.
\end{enumerate}
