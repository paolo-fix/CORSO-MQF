...
$u_t$, $r_t$, $\rho_t$, $\bar u_t$, $\lambda_t$.\newline
\textbf{Esercizi previsti:} formulazione ALM a partire dalla descrizione
finanziaria; traduzione nella forma matriciale per il solver; verifica della
fattibilit\`a temporale; funding; interpretazione dei valori duali.\newline
