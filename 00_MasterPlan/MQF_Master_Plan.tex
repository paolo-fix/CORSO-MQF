...
\begin{enumerate}
\item \texttt{MQF\_Modello\_Prompt\_zero\_inizializzazione.md}, che
definisce il prompt di inizializzazione comune;
\item \texttt{MQF\_Istruzioni\_Studente\_Uso\_Virtuoso\_IA\_Casi\_Applicativi.md},
che definisce le regole di lavoro per lo studente;
\item \texttt{MQF\_Modello\_Scheda\_Costruzione\_Caso\_Applicativo.md},
che definisce il modello generale di progettazione dei casi applicativi.
\end{enumerate}
...
\]
Documento consegnato allo studente. Contiene la specifica vincolante del
caso, ma non contiene gi\`{a} svolti il flusso logico-teorico, la
scomposizione in tappe, il notebook o l'interpretazione finale.
