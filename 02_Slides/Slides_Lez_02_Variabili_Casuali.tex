...
% !TeX root = ./Slides_Lez_02_Variabili_Casuali.tex
% ------------------------------------------------------------
...
\begin{center}
\includegraphics[width=0.78\textwidth]{../graphics/Cap02_cdf_rendimento_discreto.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.82\textwidth]{../graphics/Cap02_probabilita_area_sotto_densita.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.78\textwidth]{../graphics/Cap02_densita_uniforme_rendimento_area_01_05.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.80\textwidth]{../graphics/Cap02_normale_coda_sinistra_quantile_05.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.80\textwidth]{../graphics/Cap02_funzione_shortfall_zero.png}
\end{center}
