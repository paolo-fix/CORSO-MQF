...
%TCIDATA{LastRevised=Wednesday, May 13, 2026 22:06:18}
...
La bibliografia sar\`{a} inserita in una fase successiva. In prima istanza
pu\`{o} essere gestita manualmente mediante l'ambiente
\texttt{thebibliography}.
