...
stocastici, catene di Markov, modelli binomiali, misure di rischio e
programmazione stocastica. Si ricorrer\`{a} ad applicazioni in Python.
...
rischio, pricing discreto e programmazione stocastica.
...
seconda parte \`{e} dedicata alle catene di Markov e alle misure di rischio.
La terza parte sviluppa i modelli binomiali e il pricing discreto. La quarta
parte introduce la programmazione lineare, il CVaR e la programmazione stocastica.
...
\section*{Parte I -- Probabilit\`{a}, variabili casuali e informazione}
...
4 & Processi stocastici, traiettorie e scenari\\
5 & Applicazioni Python a processi stocastici e valori attesi
condizionati\\\hline
\end{tabular}
...
\section*{Parte II -- Catene di Markov e misure di rischio}

\begin{center}%
\begin{tabular}
[c]{ll}\hline
Capitolo & Titolo\\\hline
6 & Catene di Markov: definizioni e propriet\`{a}\\
7 & Catene di Markov e misure di rischio\\
8 & Applicazioni Python al rischio di credito\\\hline
\end{tabular}
...
\section*{Parte III -- Modelli binomiali e pricing discreto}

\begin{center}%
\begin{tabular}
[c]{ll}\hline
Capitolo & Titolo\\\hline
9 & Variabili casuali binomiali e alberi binomiali\\
10 & Applicazioni Python al pricing di opzioni e obbligazioni\\\hline
\end{tabular}
...
\section*{Parte IV -- Ottimizzazione, CVaR e programmazione stocastica}
...
12 & Dualit\`{a} nella programmazione lineare\\
13 & Applicazioni Python di programmazione lineare: calcolo del CVaR\\
14 & Programmazione lineare stocastica I\\
15 & Programmazione lineare stocastica II\\
16 & Applicazioni Python di programmazione stocastica\\\hline
\end{tabular}
...
%{\input{./Capitoli/MQF_Cap_01_Probabilita.tex}}}%
%BeginExpansion
\input{./Capitoli/MQF_Cap_01_Probabilita.tex}
%EndExpansion
...
%============================================================
%\input{./Capitoli/MQF_Cap_02_Variabili_Casuali}
%\input{./Capitoli/MQF_Cap_03_Valori_Attesi_Condizionati}
%\input{./Capitoli/MQF_Cap_04_Processi_Stocastici}
%\input{./Capitoli/MQF_Cap_05_Python_Processi_Stocastici}
%\input{./Capitoli/MQF_Cap_06_Catene_Markov}
%\input{./Capitoli/MQF_Cap_07_Markov_Misure_Rischio}
...
%\input{./Capitoli/MQF_Cap_11_Programmazione_Lineare}
%\input{./Capitoli/MQF_Cap_12_Dualita}
%\input{./Capitoli/MQF_Cap_13_Python_CVaR}
%\input{./Capitoli/MQF_Cap_14_Programmazione_Stocastica_I}
%\input{./Capitoli/MQF_Cap_15_Programmazione_Stocastica_II}
%\input{./Capitoli/MQF_Cap_16_Python_Programmazione_Stocastica}
%

%TCIMACRO{\QSubDoc{Include MQF_Cap_02_Variabili_Casuali}%
%{\input{Capitoli/MQF_Cap_02_Variabili_Casuali.tex}}}%
%BeginExpansion
\input{Capitoli/MQF_Cap_02_Variabili_Casuali.tex}
%EndExpansion
...
%TCIMACRO{\QSubDoc{Include subdoc}%
%{\input{./Capitoli/MQF_Cap_03_Valori_Attesi_Condizionati.tex}}}%
%BeginExpansion
\input{./Capitoli/MQF_Cap_03_Valori_Attesi_Condizionati.tex}
%EndExpansion
...
%BeginExpansion
\input{Capitoli/MQF_Cap_04_Python_Probabilita_Condizionamento.tex}
%EndExpansion

%************

%TCIMACRO{\QSubDoc{Include MQF_Cap_05_Processi_Stocastici_Tempo_Discreto.tex}%
%{\input{Capitoli/MQF_Cap_05_Processi_Stocastici_Tempo_Discreto.tex}}}%
%BeginExpansion
\input{Capitoli/MQF_Cap_05_Processi_Stocastici_Tempo_Discreto.tex}
%EndExpansion
...
%{\input{Capitoli/MQF_Cap_06_Processi_Stocastici_Tempo_Continuo.tex}}}%
%BeginExpansion
\input{Capitoli/MQF_Cap_06_Processi_Stocastici_Tempo_Continuo.tex}
%EndExpansion
