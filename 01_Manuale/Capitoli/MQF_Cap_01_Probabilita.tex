...
Famiglie di eventi. E' spesso utile ragruppare gli eventi. Un evento formato
come insieme di eventi \`{e} una cosa dall'evento formato dalla loro unione.
Cio\`{e} dati gli eventi $B,C$ 
